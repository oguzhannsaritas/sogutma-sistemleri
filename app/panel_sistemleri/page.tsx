            ...
            <section className="relative min-h-[600px] flex items-center overflow-hidden">
                ...
                <div className="container relative z-10 mx-auto px-4 py-16 md:py-24">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
                        ...
                        {/* METİN — mobilde altta, md+ solda */}
                        <div className="max-w-2xl order-2 md:order-1">
                            {/* Ana başlık */}
                            <h1 className="text-lg sm:text-xl md:text-3xl lg:text-3xl font-bold text-white mb-4 md:mb-6 leading-tight">
                                Soğuk Oda Panelleri
                            </h1>
                            ...
                            <div className="space-y-4 sm:space-y-5 text-[12px] sm:text-[13px] md:text-base text-white/95 leading-relaxed">
                                <p>
                                    ...
                                    edilen oluklu paneller, 111 cm standart en ile ve kilitli geçme sistemine sahip olarak üretilmektedir.
                                </p>
                                ...
                                <h2 className="text-lg sm:text-xl md:text-3xl lg:text-3xl font-bold text-white mb-2 md:mb-4 leading-tight">
                                    Kilit Detayı
                                </h2>

                                <p>
                                    Sandviç paneller, çift geçmeli kilit sistemi sayesinde birbirine tam olarak kenetlenir. Bu sistem,
                                    hem kolay montaj sağlar hem de ısı ve hava kaçaklarını engelleyerek maksimum yalıtım performansı sunar.
                                </p>
                            ...
                            <h2 className="text-lg sm:text-xl md:text-3xl lg:text-3xl font-bold text-white mt-8 mb-4 md:mb-5 leading-tight">
                                Teknik Bilgiler
                            </h2>
