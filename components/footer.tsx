    ...
    return (
        <footer className=" snap-start snap-always md:pt-16  relative overflow-hidden pt-16 pb-8" ref={ref}>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <motion.div variants={maybe(reduce) ?? fadeUp}>
                        ...
                        <div className="mt-8">
                            ...
                            <Link href="#" className="inline-flex items-center gap-2 text-sm hover:text-gray-300 transition-colors">
                                <span>📖</span>
                                Kataloğu İncele
                            </Link>
                        </div>
            ...
            <Link
                ...
                className="fixed bottom-16 right-4 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-colors z-50"
                target="_blank"
