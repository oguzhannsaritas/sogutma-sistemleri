...
export function WhyTamgucSection() {
    ...
    return (
        <motion.section
            ref={ref}
            className="snap-start snap-always min-h-screen  py-12 md:py-16 lg:py-20 md:min-h-[700px] md:md:min-h-[800px] lg:h-[900px] relative overflow-hidden flex items-center"
            initial="hidden"
            animate={controls}
        >
            <motion.div
            ...
            <motion.div className="container mx-auto px-4 relative z-10 h-full" variants={maybe(container)}>
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center h-full">
                    <motion.div className="text-white space-y-6 md:space-y-8" variants={maybe(container)}>
                        <motion.h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white" variants={maybe(fadeUp)}>
                            Neden Frigocan Soğutma?
                        </motion.h2>

                        <div className="space-y-4 md:space-y-6">
                            <motion.div variants={maybe(fadeUp)}>
                                <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 flex items-center gap-2 text-white">
                                    <CheckCircle2 className="h-5 w-5 md:h-6 md:w-6 text-white flex-shrink-0" />
                                    Üretici Firma Güvencesi
                                </h3>
                                <p className="text-sm md:text-base text-white/80 leading-relaxed">
                                    Frigocan olarak, soğuk hava depolarınızı 5.000 m² açık <br className="hidden md:inline" /> 3.000 m²
                                    kapalı alanda üretiyoruz…
                                </p>
                            </motion.div>
                        ...
                        <motion.div variants={maybe(fadeUp)}>
                            <Button
                                size="lg"
                                className="cursor-pointer text-accent bg-white w-full sm:w-auto text-sm md:text-base hover:text-white hover:bg-accent hover:border hover:border-gray-300"
                            >
                    ...
                    <motion.div className="space-y-6" variants={maybe(container)}>
                            ...
                            <Card className="bg-white border-2 border-white p-6 md:p-8 text-accent">
                                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 md:gap-6 mb-4">
                                    <div className="flex items-center gap-4 w-full sm:w-auto">
                                        ...
                                        <h3 className="text-xl md:text-2xl font-bold text-center sm:text-left text-accent">
                                ...
                                <p className="text-sm md:text-base text-gray-500 mb-6">Soğutma sistemleri için hemen teklif alın !</p>
                                <Button className="w-full border cursor-pointer border-gray-300 bg-accent text-white text-sm md:text-base">
                                    Teklif Al
                                </Button>
                            </Card>
                        </motion.div>
                        ...
                        <motion.p className="text-white text-center text-xs md:text-sm" variants={maybe(fadeUp)}>
